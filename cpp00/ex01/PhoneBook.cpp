...
/*   Updated: 2023/11/23 17:40:11 by fouaouri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Contact::set_len(int index){
	...
	if (getPhoneNumber().length() > 10)
		std::cout << std::setw(10) << getPhoneNumber().substr(0, 9) << ".|";
	else
		std::cout << std::setw(10) << getPhoneNumber() << "|";
	if (getDarketsSec().length() > 10)
		std::cout << std::setw(10) << getDarketsSec().substr(0, 9) << "." << std::endl;
	else
